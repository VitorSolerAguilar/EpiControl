namespace EpiControl.Views.Norma_Regulamentadora
{
	partial class ExcluirNr
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ExcluirNr));
			panel1 = new Panel();
			label2 = new Label();
			label1 = new Label();
			...
			btn_voltar.Location = new Point(362, 433);
			...
			button1.Location = new Point(461, 433);
