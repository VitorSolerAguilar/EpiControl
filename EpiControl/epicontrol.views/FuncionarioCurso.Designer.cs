namespace EpiControl.epicontrol.views
{
    partial class FuncionarioCurso
    {
		...
		private void InitializeComponent()
		{
			...
			// maskedTextBox3
			// 
			maskedTextBox3.Location = new Point(101, 211);
			maskedTextBox3.Mask = "00/00/0000";
			maskedTextBox3.Name = "maskedTextBox3";
			maskedTextBox3.Size = new Size(98, 23);
			maskedTextBox3.TabIndex = 76;
			maskedTextBox3.ValidatingType = typeof(DateTime);
			// 
			// btnVoltar
			// 
			btnVoltar.BackColor = Color.Transparent;
			btnVoltar.Location = new Point(252, 280);
			...
			btnSalvar.Location = new Point(342, 280);
