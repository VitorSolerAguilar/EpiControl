...
namespace EpiControl
{
    public partial class frmHome : Form
    {
        ...
        private void btnGerarRelatorioEpi_Click(object sender, EventArgs e)
        {
            fmrGerarRelatorioEpi gerarRelatorioEpi = new fmrGerarRelatorioEpi();

            gerarRelatorioEpi.FormClosed += (s, args) => this.Show();
            this.Hide();
        ...
        private void transicaoMenuEstoque_Tick(object sender, EventArgs e)
        {
            ...
            {
                flpEstoque.Height -= 20;
                if (flpEstoque.Height <= 55)
                {
                    transicaoMenuEstoque.Stop();
                    menuExpand = false;
                }
