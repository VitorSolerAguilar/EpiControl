namespace EpiControl.epicontrol.views
{
	partial class frmConsultarEmprestimo
	{
		...
		private void InitializeComponent()
		{
			...
			txtConsultaEmprestimo = new TextBox();
			...
			// 
			txtConsultaEmprestimo.Location = new Point(298, 80);
			txtConsultaEmprestimo.Name = "txtConsultaEmprestimo";
			txtConsultaEmprestimo.Size = new Size(226, 23);
			txtConsultaEmprestimo.TabIndex = 23;
			// 
			// dgvEmprestimo
			// 
		...
		private TextBox txtConsultaEmprestimo;
