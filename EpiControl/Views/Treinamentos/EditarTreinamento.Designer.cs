...
{
	partial class EditarTreinamento
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EditarTreinamento));
			panel1 = new Panel();
			label2 = new Label();
			label1 = new Label();
			...
			label2.TabIndex = 3;
			label2.Text = "EDITAR TREINAMENTO";
			// 
			// label1
			// 
			...
			comboBox1.Location = new Point(169, 71);
			...
			button2.Location = new Point(524, 71);
			...
			btn_voltar.Location = new Point(423, 444);
			btn_voltar.Name = "btn_voltar";
			btn_voltar.Size = new Size(75, 40);
			btn_voltar.TabIndex = 58;
			...
			button1.Location = new Point(524, 444);
			...
			label3.Location = new Point(48, 392);
			label3.Name = "label3";
			...
			// dateTimePicker2
			// 
			dateTimePicker2.Location = new Point(169, 386);
			...
			label6.Location = new Point(48, 341);
			label6.Name = "label6";
			...
			// dateTimePicker1
			// 
			dateTimePicker1.Location = new Point(169, 335);
			...
			// richTextBox1
			// 
			richTextBox1.Location = new Point(169, 154);
			...
			label5.Location = new Point(48, 157);
			label5.Name = "label5";
