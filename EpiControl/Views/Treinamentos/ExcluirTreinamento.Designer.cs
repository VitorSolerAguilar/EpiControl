...
{
	partial class ExcluirTreinamento
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ExcluirTreinamento));
			panel1 = new Panel();
			label2 = new Label();
			label1 = new Label();
			...
			label2.TabIndex = 3;
			label2.Text = "EXCLUIR TREINAMENTO";
			// 
			// label1
			// 
			...
			btn_voltar.Location = new Point(433, 476);
			...
			button1.Location = new Point(534, 476);
			...
			label3.Location = new Point(58, 424);
			label3.Name = "label3";
			...
			// dateTimePicker2
			// 
			dateTimePicker2.Location = new Point(179, 418);
			...
			label6.Location = new Point(58, 373);
			label6.Name = "label6";
			...
			// dateTimePicker1
			// 
			dateTimePicker1.Location = new Point(179, 367);
			...
			// richTextBox1
			// 
			richTextBox1.Location = new Point(179, 186);
			...
			button2.Location = new Point(534, 89);
			...
			comboBox1.Location = new Point(179, 90);
			...
			label7.Location = new Point(-11, 141);
			label7.Name = "label7";
			...
			Controls.Add(label4);
			Controls.Add(panel1);
			Name = "ExcluirTreinamento";
			Text = "ExcluirTreinamento";
